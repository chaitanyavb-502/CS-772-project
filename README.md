...
This project implements a sentiment analysis model to classify IMDB movie reviews as either positive or negative. It utilizes a Long Short-Term Memory (LSTM) network, a type of recurrent neural network (RNN) well-suited for processing sequential data like text.  A key innovation in this project is the incorporation of priors generated by Large Language Models (LLMs) to enhance the LSTM's performance.
